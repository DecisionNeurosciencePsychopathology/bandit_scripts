...
num2str(injectNoise);
load(sprintf('~/Box Sync/skinner/data/eprime/bandit/vba_pseudosub/data/2lr_decay/%s/vba_MFX_output/bandit_vba_MFX_output_2lr_decay.mat',num2str(injectNoise)))
