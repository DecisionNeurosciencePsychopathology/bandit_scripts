...
bdf = bdf %>% group_by(ID) %>%
  mutate(
    ...
    rmin6 = lag(r, n = 6, order_by = Trial),
    ...
    Amin6 = lag(A, n = 6, order_by = Trial),
    ...
    Bmin6 = lag(B, n = 6, order_by = Trial),
    ...
    Cmin6 = lag(C, n = 6, order_by = Trial)
...
bdf = bdf %>% group_by(ID) %>%
  mutate(
    ...
    Amin5rmin6 = Amin5 * rmin6,

    Amin6rmin1 = Amin6 * rmin1,
    Amin6rmin2 = Amin6 * rmin2,
    Amin6rmin3 = Amin6 * rmin3,
    Amin6rmin4 = Amin6 * rmin4,
    Amin6rmin5 = Amin6 * rmin5,
    Amin6rmin6 = Amin6 * rmin6,
    ...
    Bmin5rmin6 = Bmin5 * rmin6,
    
    Bmin6rmin1 = Bmin6 * rmin1,
    Bmin6rmin2 = Bmin6 * rmin2,
    Bmin6rmin3 = Bmin6 * rmin3,
    Bmin6rmin4 = Bmin6 * rmin4,
    Bmin6rmin5 = Bmin6 * rmin5,
    Bmin6rmin6 = Bmin6 * rmin6,
    ...
    Cmin5rmin6 = Cmin5 * rmin6,
    
    Cmin6rmin1 = Cmin6 * rmin1,
    Cmin6rmin2 = Cmin6 * rmin2,
    Cmin6rmin3 = Cmin6 * rmin3,
    Cmin6rmin4 = Cmin6 * rmin4,
    Cmin6rmin5 = Cmin6 * rmin5,
    Cmin6rmin6 = Cmin6 * rmin6
    
    
  ) %>% ungroup()

# same thing for the replication sample
# imaging study first
# rename for clarity and get lags
rdf$r <- rdf$reinf_n
rdf$A <- rdf$choiceA
