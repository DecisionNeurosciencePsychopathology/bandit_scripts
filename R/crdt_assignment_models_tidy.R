...
A_reg_all5 = glmer(
  A ~
    ...
    Amin2rmin1 + Amin2rmin2 + Amin2rmin3 +
    Amin3rmin1 + Amin3rmin2 + Amin3rmin3 +
    Amin4rmin1 + Amin4rmin2 + Amin4rmin3 +
    Amin5rmin1 + Amin5rmin2 + Amin5rmin3 +
    (1 | ID),
  data = bdf,
  family = binomial,
  glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 100000))
...
B_reg_all5 = glmer(
  B ~
    Bmin1rmin1 + Bmin1rmin2 + Bmin1rmin3 +
    Bmin2rmin1 + Bmin2rmin2 + Bmin2rmin3 +
    Bmin3rmin1 + Bmin3rmin2 + Bmin3rmin3 +
    Bmin4rmin1 + Bmin4rmin2 + Bmin4rmin3 +
    Bmin5rmin1 + Bmin5rmin2 + Bmin5rmin3 +
    (1 | ID),
  data = bdf,
  family = binomial,
  glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 100000))
...
C_reg_all5 = glmer(
  C ~
    Cmin1rmin1 + Cmin1rmin2 + Cmin1rmin3 +
    Cmin2rmin1 + Cmin2rmin2 + Cmin2rmin3 +
    Cmin3rmin1 + Cmin3rmin2 + Cmin3rmin3 +
    Cmin4rmin1 + Cmin4rmin2 + Cmin4rmin3 +
    Cmin5rmin1 + Cmin5rmin2 + Cmin5rmin3 +
    (1 | ID),
  data = bdf,
  family = binomial,
  glmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 100000))
...
all_coeffs_combined_matrix5 = matrix(data = all_coeffs_combined5[2:10],nrow = 5,ncol=5)
corrplot(all_coeffs_combined_matrix5/max(all_coeffs_combined_matrix5), method = "color")
